    ...
    return (
        <>
            <section className="section" id="process">
                <p className="section-label face-up">How I work</p>
                <h2 className="section-heading face-up delay-1">A process built on <em>curiosity</em></h2>
                <div className="process-steps">
                    <div className="step face-up">
                    ...
                    <div className="step face-up delay-1">
                    ...
                    <div className="step face-up delay-2">
                    ...
                    <div className="step face-up delay-3">
